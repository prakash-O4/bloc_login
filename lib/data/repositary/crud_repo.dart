...
class CRUDRepo {
  final name = TextConstant.displayName;
  ...
  //constructor which takes the display name of the user for new collection in the firebase.
  //collection reference means it points towards the collection
  //here "users" point towards the collection "notes"
  final users =
      FirebaseFirestore.instance.collection(TextConstant.displayName!);
