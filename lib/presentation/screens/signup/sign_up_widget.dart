      ...
      child: Column(
        children: [
          Padding(
            ...
            child: StyleConstants.kCompanyName,
          ),
    ...
    return BlocBuilder<SignupBloc, SignupState>(
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (value) =>
              _signupBloc.add(SignUpPasswordChanged(password: value.trim())),
          validator: (value) =>
    ...
    return BlocBuilder<SignupBloc, SignupState>(
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (value) => _signupBloc
              .add(SignUpConfPassChanged(confPassword: value.trim())),
          validator: (value) =>
  ...
  Widget _googleButton() {
    return Container(
      ...
      child: ElevatedButton.icon(
        ...
        label: StyleConstants.kButtonText("Google Sign In"),
      ),
    );
  }
}
